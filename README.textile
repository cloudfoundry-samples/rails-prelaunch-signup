...
Cloud Foundry will automatically run @$ rake db:migrate@ to setup your database during staging of the application.

h3. Seeding the Database

Use the vmc rails-console to seed the database once your application is deployed on Cloud Foundry.  Note that memory used while running the console contributes to your overall application memory limit.

<pre>
vmc rails-console mynewsite
...
Connecting to 'mynewsite' console: OK
